...
public class MaterialController {
    ...
    @PreAuthorize(
            "hasRole('ADMIN') or @enrollmentService.isTeacherOfMaterial(authentication.principal.userId, #materialId)")
    public ResponseEntity<ApiResponse<?>> putMaterial(
            @PathVariable String materialId, @RequestBody MaterialRequestDTO request) {
